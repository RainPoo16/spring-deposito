...
4. **Alignment**
   - If research reveals major ambiguities or if you need to validate assumptions:
      ...
      - If answers significantly change the scope, loop back to **Explore the Codebase**

5. **Stop at 90% Confidence:**
...
3. Use #tool:vscode/askQuestions for approval or follow up questions and wait for user to confirm before proceeding with handoff

**Refinement**
On user input after showing the plan:
- Changes requested → revise and present updated plan.
- Questions asked → clarify, or use #tool:vscode/askQuestions for follow-ups
- Alternatives wanted → loop back to **Explore the Codebase** with new subagent
