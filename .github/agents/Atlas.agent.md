...
4. **MANDATORY STOP**: Use #tool:vscode/askQuestions and wait for user to:
   - Make the git commit
   - Confirm readiness to proceed to next phase
   - Request changes or abort
   - Skip commit and proceed to next phase (not recommended, but allow if user insists)
...
UNLESS IF USER ASKS YOU TO SKIP MANDATORY STOP POINTS. OTHERWISE, FOLLOW THESE STRICTLY.
</stopping_rules>
